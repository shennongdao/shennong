...
| 用户间自由转账 | 第一阶段关闭 | `token.walletTransferEnabled` | 第一阶段只支持 DAO 资金池通过任务付款到钱包。 |
...
| `Mark-Conversion-Status` | Task Process | `paymentIds`、`status`、`disputeId`、`reason` | `Conversion-Status-Changed` | `UNAUTHORIZED`、`NOT_FOUND` |
